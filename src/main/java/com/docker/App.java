...
public class App {
  ...
  protected static HttpServer startServer() {
    // create a resource config that scans for JAX-RS resources and providers in com.docker package
    final ResourceConfig rc = new ResourceConfig().packages("com.docker");
